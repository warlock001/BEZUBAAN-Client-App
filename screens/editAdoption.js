...
export default function EditAdoption({ navigation }) {
    ...
    async function deletePet(id) {
        ...
        axios({
            method: 'DELETE',
            url: `${REACT_APP_BASE_URL}/adoption?id=${id}`,
        }).then(() => {
            ...
            <View>
                ...
                <View
                    ...
                    <TouchableOpacity onPress={() => {
                        deletePet(item._id)
                    }} style={{ backgroundColor: '#cf3339', paddingVertical: 5, paddingHorizontal: 20, borderRadius: 15, marginHorizontal: 10 }}>
                        <Text style={{ fontSize: 20, color: '#fff' }}>Delete</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => {
                        navigation.navigate('Edit Pet', { ...item });
                    }} style={{ backgroundColor: '#fff', borderWidth: 2, borderColor: '#cf3339', paddingVertical: 5, paddingHorizontal: 20, borderRadius: 15, marginHorizontal: 10 }}>
                        <Text style={{ fontSize: 20, color: '#cf3339' }}>Edit</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </View>
    ...
    useFocusEffect(
        React.useCallback(async () => {
            ...
            axios({
                method: 'GET',
                url: `${REACT_APP_BASE_URL}/adoption?user=${id}`,
            })
                .then(async res => {

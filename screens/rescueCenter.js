    ...
    useEffect(() => {
      async function fetchLocation() {
        ...
        const Location = await axios.get(
          `https://us1.locationiq.com/v1/reverse?key=pk.8a577d1b155ce4938bc3dbe2b851c181&lat=${loc.latitude}&lon=${loc.longitude}&format=json`,
        );
      ...
      <TouchableOpacity
        ...
        <View
          ...
          <TouchableOpacity
            onPress={() => {
              Linking.openURL(
                'https://www.google.com/maps/dir/?api=1&travelmode=driving&dir_action=navigate&destination=-33.8600024%2C18.697459&origin=-33.8356372%2C18.6947617',
              );
            }}>
